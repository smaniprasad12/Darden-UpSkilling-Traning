...
//		
    ...
    public void getAllTest()throws Exception {
       ...
       list.add(Employee.builder().id(3).firstname("naveen").lastname("sri").role("Sranalyst").build());
       list.add(Employee.builder().id(4).firstname("vinny").lastname("sri").role("analyst").build());
...
//	@Test
//    public void getEmpByIdN()throws Exception  {
//    	
//    	 int id=100;
//    	 Employee employee=Employee.builder()
// 				.id(1)
